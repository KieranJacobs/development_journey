...
ALLOWED_EXTENSIONS = {e.strip().lower() for e in os.getenv('ALLOWED_EXTENSIONS', 'png,jpg,jpeg,gif,pdf,txt,md').split(',') if e.strip()}
...
def add_task(project_id):
    if request.is_json:
        ...
        # Assignee input ignored for Version 6.5 — backend enforces 'unassigned'
